      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
        ...
        <div className="flex flex-col justify-between space-y-4">
          ...
          <div className="bg-[#1E0427] border border-[#8E156A]/40 rounded-2xl p-4 space-y-3">
            ...
            <a
              href={BRAND_INFO.whatsappDeliveryUrl}
              target="_blank"
              rel="noreferrer"
              className="w-full inline-flex items-center justify-center gap-2 btn-whatsapp-vibrant btn-whatsapp-pulse text-xs py-3.5 rounded-xl uppercase tracking-tight shadow-[0_0_20px_rgba(0,230,118,0.5)] active:scale-95 cursor-pointer"
            >
